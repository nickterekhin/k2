...
<html xmlns="http://www.w3.org/1999/xhtml"
      ...
      layout:decorator="~{index(page_title='Customers - Edit One')}">
<head>
    <title>Customers - Edit One</title>
</head>
<body>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="FirstName" class="form-control" id="FirstName" value="" th:value="${customer.getFirstName()}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label text-md-right font-weight-bold" for="LastName">Last Name</label>
                                    <div class="col-md-10">
                                        <input type="text" name="LastName" class="form-control" required id="LastName" th:value="${customer.getLastName()}"/>
                                    </div>
                                </div>
